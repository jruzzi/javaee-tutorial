...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:batch-processing008.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:batch-processing010.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
* link:#BABDEIFG[Section 55.9.1, "Architecture of the phonebilling
Example Application"]
* link:#BABBGDAA[Section 55.9.2, "Running the phonebilling Example
Application"]
...
* link:#BABIBBBG[Section 55.9.2.1, "To Run the phonebilling Example
Application Using NetBeans IDE"]
* link:#BABFHIIB[Section 55.9.2.2, "To Run the phonebilling Example
