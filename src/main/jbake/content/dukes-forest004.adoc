...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:dukes-forest003.html[image:img/leftnav.gif[Previous] +
Previous]  | 
|=======================================================================
...
* link:#CHDBDEHH[Section 59.4.1, "To Register as a Duke's Store
Customer"]
* link:#CHDCEJIC[Section 59.4.2, "To Purchase Products"]
* link:#CHDICAIJ[Section 59.4.3, "To Approve Shipment of a Product"]
* link:#CHDIFEGC[Section 59.4.4, "To Create a New Product"]
