...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:dukes-tutoring001.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:dukes-tutoring003.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
* link:#GKAFJ[Section 58.2.1, "Java Persistence API Entities Used in the
Main Interface"]
* link:#GKAFC[Section 58.2.2, "Enterprise Beans Used in the Main
Interface"]
* link:#BCGHHCDA[Section 58.2.3, "WebSocket Endpoint Used in the Main
Interface"]
* link:#GKAET[Section 58.2.4, "Facelets Files Used in the Main
Interface"]
* link:#GKADH[Section 58.2.5, "Helper Classes Used in the Main
Interface"]
* link:#GKADA[Section 58.2.6, "Properties Files"]
* link:#GKAEV[Section 58.2.7, "Deployment Descriptors Used in Duke's
Tutoring"]
...
Properties] and link:bean-validation-advanced.html#GKAHP[Chapter 22,
