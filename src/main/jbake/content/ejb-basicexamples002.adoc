...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:ejb-basicexamples001.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:ejb-basicexamples003.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
* link:#BNBOL[Section 34.2.5.1, "To Run the cart Example Using NetBeans
IDE"]
* link:#BNBON[Section 34.2.5.2, "To Run the cart Example Using Maven"]
