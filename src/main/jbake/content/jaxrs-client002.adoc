...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:jaxrs-client001.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:jaxrs-client003.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
* link:#BABEDFIG[Section 30.2.1, "The Client API in the rsvp Example
Application"]
* link:#CHDGBGID[Section 30.2.2, "The Client API in the customer Example
Application"]
...
29, "The rsvp Example Application"]. The web application uses the Client
...
link:jaxrs-advanced008.html#GKOIB[Chapter 31, "The customer Example
