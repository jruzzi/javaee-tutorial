...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:jaxrs-client002.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:jaxrs-advanced.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
* link:#CHDGBBCC[Section 30.3.1, "Configuring the Client Request"]
* link:#CHDEBIGG[Section 30.3.2, "Asynchronous Invocations in the Client
API"]
...
* link:#CHDHAFBG[Section 30.3.1.1, "Setting Message Headers in the
Client Request"]
* link:#CHDHFFDJ[Section 30.3.1.2, "Setting Cookies in the Client
Request"]
* link:#CHDJEFID[Section 30.3.1.3, "Adding Filters to the Client"]
...
30.3.2.2 Using Reactive Approach in Asynchronous Invocations
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
30.3.3 Using Server-Sent Events
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
30.3.4 Overview of the SSE API
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
30.3.6 Listening and Receiving Events
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
