...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:jms-examples004.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:jms-examples006.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
* link:#BABIBEAC[Section 46.5.1, "Using Shared Nondurable
Subscriptions"]
* link:#BABEJBHA[Section 46.5.2, "Using Shared Durable Subscriptions"]
