...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:jsf-configure012.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:servlets.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
16.13.1.2 To Specify a Path to an Application Configuration Resource
File
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
