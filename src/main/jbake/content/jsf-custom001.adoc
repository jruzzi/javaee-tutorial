...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:jsf-custom.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:jsf-custom002.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
application. See link:dukes-bookstore.html#GLNVI[Chapter 57, "Duke's
