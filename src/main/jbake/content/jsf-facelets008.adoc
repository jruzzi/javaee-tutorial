...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:jsf-facelets007.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:jsf-facelets009.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
* link:#BABGEDEB[Section 8.8.1.1, "Configuring the hello1-rlc Example"]
* link:#BABDHCFG[Section 8.8.1.2, "The Facelets Pages for the hello1-rlc
Example"]
* link:#BABBGFFF[Section 8.8.1.3, "To Build, Package, and Deploy the
hello1-rlc Example Using NetBeans IDE"]
* link:#BABJAGFB[Section 8.8.1.4, "To Build, Package, and Deploy the
hello1-rlc Example Using Maven"]
* link:#BABFCHEB[Section 8.8.1.5, "To Run the hello1-rlc Example"]
...
8.8.1.3 To Build, Package, and Deploy the hello1-rlc Example Using
NetBeans IDE
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
