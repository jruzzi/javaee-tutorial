...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:servlets004.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:servlets006.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
See link:webi18n.html#BNAXU[Chapter 20, "Internationalizing and
