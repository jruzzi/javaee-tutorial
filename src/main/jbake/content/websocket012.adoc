...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:websocket011.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:websocket013.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
* link:#CIHICIDE[Section 18.12.1, "Architecture of the websocketbot
Example Application"]
* link:#CIHHJHDB[Section 18.12.2, "Running the websocketbot Example
Application"]
...
* link:#CIHDAEHF[Section 18.12.1.1, "The CDI Bean"] – A CDI bean
(`BotBean`) that contains the logic for the bot agent to reply to
messages
* link:#CIHJJJHG[Section 18.12.1.2, "The WebSocket Endpoint"] – A
WebSocket endpoint (`BotEndpoint`) that implements the chat room
* link:#CIHFDGHG[Section 18.12.1.3, "The Application Messages"] – A set
of classes (`Message`, `ChatMessage`, `InfoMessage`, `JoinMessage`, and
`UsersMessage`) that represent application messages
* link:#CIHGHHBD[Section 18.12.1.4, "The Encoder Classes"] – A set of
classes (`ChatMessageEncoder`, `InfoMessageEncoder`,
`JoinMessageEncoder`, and `UsersMessageEncoder`) that encode application
messages into WebSocket text messages as JSON data
* link:#CIHHFICG[Section 18.12.1.5, "The Message Decoder"] – A class
(`MessageDecoder`) the parses WebSocket text messages as JSON data and
decodes them into `JoinMessage` or `ChatMessage` objects
* link:websocket011.html#CIHHIEFH[Section 18.11.1.3, "The HTML Page"] –
An HTML page (`index.html`) that uses JavaScript code to implement the
...
Refer to link:concurrency-utilities.html#GKJIQ8[Chapter 56, "Concurrency
...
* link:#CIHFDDGE[Section 18.12.2.1, "To Run the websocketbot Example
Application Using NetBeans IDE"]
* link:#CIHEDEHB[Section 18.12.2.2, "To Run the websocketbot Example
Application Using Maven"]
* link:#BABDDAAG[Section 18.12.2.3, "To Test the websocketbot Example
Application"]
